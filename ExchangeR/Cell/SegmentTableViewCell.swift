...
//  ExchangeR
//
//  Created by Robert Moryson on 17/02/2020.
...
class SegmentTableViewCell: UITableViewCell {
    ...
    //losowo wybierany jest kolor tła dla kodu waluty
    ...
    //tworzy gradient z dwóch kolorów oraz ustawia go pod codeBG
    func makeGradient(thisView: UIView) {
        let colors = cellRandomBackgroundColors()
        thisView.setGradientBackgroundColor(colorOne: colors[0], colorTow: colors[1])
    }
